 ...
 */
  ...
  await addConfigFile(config, etc, 'dcp/dcp-client/dcp-config.js');
  programName && await addConfigRKey(config, 'HKLM', `dcp-client/${programName}/dcp-config`);
  programName && await addConfigFile(config, etc, `dcp/dcp-client/${programName}/dcp-config.js`);
  ...
  await addConfigFile(localConfig, etc, 'dcp/override/dcp-config.js');
